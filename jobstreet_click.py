...
def _buat_teks_surat_lamaran(job_title, company):
    ...
    return (
        ...
        "My name is Duwi Anjar Ari Wibowo, and I hold a Bachelor's degree in Informatics from Universitas "
        "Ahmad Dahlan with a GPA of 3.72. I am writing to express my interest in the "
        f"{posisi} position at {perusahaan}.\n\n"
        "I have professional experience as a Full-Stack Developer, with strong exposure to front-end "
        "development in building responsive and user-focused web applications. My technical background "
        "includes Laravel, JavaScript, React.js, Svelte/SvelteKit, Tailwind CSS, Bootstrap, HTML, CSS, and "
        "AJAX/Fetch, along with experience integrating front-end interfaces with REST APIs and backend "
        "systems.\n\n"
        "In my current role at SPD Speedometer (PT Radiator Springs Indonesia), I develop and maintain "
        "internal systems such as SSO portals, warranty applications, admin dashboards, and backend-connected "
        "mobile solutions. I have also contributed to database design, query optimization, authentication and "
        "role-based access control, as well as feature development to improve application performance and "
        "usability. Previously, during my internship at PT Baracipta Esa Engineering, I developed responsive "
        "admin pages with AJAX to support efficient data entry, filtering, and updates.\n\n"
        "Beyond my work experience, I have built several projects including an SSO Portal, Warranty Web App, "
        "ERP System, CMS/Admin Dashboard, SEO-friendly Landing Pages, and a Workshop Management System. "
        "These projects strengthened my ability to translate business requirements into functional, clean, "
        "and maintainable interfaces.\n\n"
        "I also hold certifications in Junior Network Administrator and Java Full-Stack Developer, which "
        "further support my technical foundation in software development and system implementation.\n\n"
        "I would welcome the opportunity to contribute my skills, grow as a developer, and be part of your "
        "team. Thank you for your time and consideration.\n\n"
        "Sincerely,\n"
        "Duwi Anjar Ari Wibowo\n"
        "duwianjarariwibowo@gmail.com | +62 822-2064-9676"
    )
